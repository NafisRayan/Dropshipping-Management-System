...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Product with SKU already exists' }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'search', required: false, description: 'Search by name, description, or SKU' }),
